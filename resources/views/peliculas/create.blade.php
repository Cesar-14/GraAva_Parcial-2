...
<body>
    ...
    <div class="contenido">
        <h3>Nueva pelicula</h3> <hr>

        <div class="contenedor-formulario">
            <form action="{{route('peliculas.store')}}" method="POST" class="row g-3" id="formulario">
                @csrf
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="validationDefault01" name="director">
                </div>
                <div class="col-md-4">
                    <label for="validationDefault01" class="form-label">Año</label>
                    <input type="number" class="form-control" id="validationDefault01" name="año">
                </div>
                <div class="col-md-4">
                    <label for="validationDefault01" class="form-label">URL de imágen</label>
                    <input type="text" class="form-control" id="validationDefault01" name="foto">
                </div>
                    
                <div class="col-md-3">
                    <label for="validationDefault04" class="form-label">Genero</label>
                    <select name="genero" class="form-select" id="validationDefault04">
        ...
        <div action="{{route('peliculas.store')}}" class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
