        ...
        <h2>Próximamente</h2> <hr>
            <div class="contenido-peliculas">
                ...
                <div class="card" >
                    ...
                    <div class="cartaBotones">
                        <button type="button" class="btn btn-primary" id="cartaBoton"><a href="{{route('peliculas.delete',$pelicula->id)}}">Eliminar</a></button>
                        <button type="button" class="btn btn-primary" id="cartaBoton"><a href="{{route('peliculas.edit',$pelicula->id)}}">Editar</a></button>
                    </div>
                </div>  
                @endforeach
                <div class="card" id="añadir">
                    <a href="/menu/create">
                        <img class="añadir-icono" src="https://cdn-icons-png.flaticon.com/512/32/32339.png" alt="">
                    </a>
                </div>
            </div>
        </div>
